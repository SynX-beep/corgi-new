    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Epic Games Verify Setup', 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Epic_Games_logo.svg/882px-Epic_Games_logo.svg.png', 'https://discord.gg/corgi')
          ...
          case "Enable Verification":
            ...
            .then(async collected => {
              ...
              if(message.mentions.channels.filter(ch=>ch.guild.id==message.guild.id).first()){
                ...
                channel.send({
                  embeds: [
                    new MessageEmbed().setColor(es.color).setFooter(message.guild.name + " | Powered by: discord.gg/corgi", message.guild.iconURL({dynamic: true})).setThumbnail(es.thumb ? message.guild.iconURL({dynamic: true}) : null)
