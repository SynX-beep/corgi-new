    ...
    try {
      ...
      async function first_layer() {
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Twitter Setup', 'https://cdn.discordapp.com/emojis/840255600851812393.png?size=96', 'https://discord.gg/corgi')
...
/**
 * @INFO
 * Bot Coded by S7NX#6966 | https://github?.com/corgiDev/discord-js-lavalink-Music-Bot-erela-js
 * @INFO
