...
module.exports = {
	...
	run: async (client, message, args, cmduser, text, prefix) => {
		...
		try {	
			...
			let button_support_dc = new MessageButton().setStyle('LINK').setLabel(client.la[ls].cmds.info.github?.buttons.dc).setURL("https://discord.gg/corgi")
			let button_invite = new MessageButton().setStyle('LINK').setLabel(client.la[ls].cmds.info.github?.buttons.botlist).setURL(`https://botlist.corgi.eu`)
			...
			message.reply({embeds: [new MessageEmbed()
				...
				.addField("🆕 NEW GITHUB", `> There is now an **open Source** Version of this Bot on [\`S7NX#6966\`'s Github](https://github.com/S7NX6966)\n> [Link](https://github.com/S7NX6966/Multipurpose-discord-bot) but please make sure to **give __Credits__** if you use it!\n> Make sure to read the [README](https://github.com/S7NX6966/Multipurpose-discord-bot#readme) and the [WIKI / FAQ](https://github.com/S7NX6966/Multipurpose-discord-bot/wiki) carefully before opening an [ISSUE](https://github.com/S7NX6966/Multipurpose-discord-bot/issues/new/choose)`)
