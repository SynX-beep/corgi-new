...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let button_support_dc = new MessageButton().setStyle('LINK').setLabel('Support Server').setURL("https://discord.com/gg/corgi")
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter('Clan Bot | powered by corgi.eu', 'https://imgur.com/jPItIw0.gif')
