...
module.exports = {
	...
	try{
		    ...
		    .setURL("http://bero-host.de/?utm_source=bot&utm_medium=cpc&utm_id=corgi")
		    .setDescription(`
...
<:arrow:832598861813776394> Our suggestion is, if you want to host Bots / Games / Websites, then go to [BERO-HOST.de](http://bero-host.de/?utm_source=bot&utm_medium=cpc&utm_id=corgi)
...
[**Website:**](http://bero-host.de/?utm_source=bot&utm_medium=cpc&utm_id=corgi)
[**__SPONSOR LINK!__**](https://corgi.eu/img/paysafecard.png)
`)
