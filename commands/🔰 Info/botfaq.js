...
module.exports = {
    ...
    let es = client.settings.get(message.guild.id, "embed");let ls = client.settings.get(message.guild.id, "language")
		...
		try{
      let corgidc = client.guilds.cache.get("984212857694597241")
      let corgimembers = await corgidc.members.fetch().catch(() => {});
      let partnercount = corgimembers.filter(m => m.roles.cache.has("823150244509515807"))
      ...
      .setColor(es.color)
      .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/corgi")
