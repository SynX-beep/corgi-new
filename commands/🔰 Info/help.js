  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("930608434603262045").setLabel("Invite Me").setURL("https://discord.com/api/oauth2/authorize?client_id=934903628832059422&permissions=8&scope=bot%20applications.commands")
        let menuOptions = [
          {
            label: "Overview",
            value: "Overview",
...
but you can also do \`${prefix}setup\` e.g. \`${prefix}setup-welcome\``)
